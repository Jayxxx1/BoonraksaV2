...
export default function DigitizerTaskBoard() {
  ...
  const hasEmbroideryFiles = (order) => {
    const hasLegacyFile =
      typeof order?.embroideryFileUrl === "string" &&
      order.embroideryFileUrl.trim() !== "";
    const hasMultiFiles =
      Array.isArray(order?.embroideryFileUrls) &&
      order.embroideryFileUrls.some(
        (url) => typeof url === "string" && url.trim() !== "",
      );
    return hasLegacyFile || hasMultiFiles;
  };
        ...
        <div className="erp-page-header">
          <div className="space-y-0.5">
            ...
            <p className="erp-page-subtitle">
              รับงานตีลาย อัปโหลดไฟล์ .emb และระบุสีด้าย
            </p>
          </div>
                      ...
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex flex-col gap-1.5 w-full">
                          <div className="flex justify-between items-start">
                            ...
                            <span
                              className={`erp-status-badge flex-shrink-0 text-center ${order.status === "PENDING_DIGITIZING" ? "bg-amber-100 text-amber-600 border-amber-200" : "bg-slate-100 text-slate-400 border-slate-200"}`}
                            >
                              {getStatusLabel(order.status)}
                            </span>
                          </div>
