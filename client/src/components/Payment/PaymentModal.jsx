...
export default function PaymentModal({ order, onClose, onSuccess }) {
  ...
  return (
    <div className="erp-modal-overlay">
      <div className="erp-modal-content w-[98%] max-w-4xl p-8 sm:p-10">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex bg-slate-100 p-1.5 rounded-md mb-2">
                <button
                  type="button"
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-6 py-5 bg-slate-50 border-2 rounded-md font-black text-2xl text-slate-800 outline-none transition-all ${
                  Number(amount) > Number(order.balanceDue)
            ...
            <div className="space-y-6">
              ...
              {paymentMethod === "TRANSFER" ? (
                <div>
                  ...
                  <div
                    ...
                    className="aspect-[4/3] bg-slate-50 border-2 border-dashed border-slate-200 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-slate-100 transition-all overflow-hidden relative group"
                  >
                    {preview ? (
                      <>
                        <img
                ...
                <div className="aspect-[4/3] bg-orange-50 p-8 rounded-lg border-2 border-orange-100 flex flex-col items-center justify-center space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-6 py-4 bg-slate-50 border-2 border-slate-100 rounded-md font-bold text-slate-800 h-24 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-50 outline-none resize-none"
                  placeholder={
                    paymentMethod === "TRANSFER"
                      ? "เช่น โอนมัดจำรอบแรก..."
            ...
            <div className="pt-4">
              {Number(order.balanceDue) <= 0 ? (
                <button
                  type="button"
                  onClick={onClose}
                  className="w-full py-5 text-lg text-white bg-emerald-500 rounded-lg font-black shadow-xl shadow-emerald-200 hover:bg-emerald-600 transition-all active:scale-95"
                >
                ...
                <button
                  ...
                  className={`w-full py-5 text-lg text-white rounded-lg font-black shadow-xl transition-all disabled:opacity-50 disabled:shadow-none active:scale-95 ${
                    paymentMethod === "TRANSFER"
